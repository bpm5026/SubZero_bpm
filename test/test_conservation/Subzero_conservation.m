function [K,T] = Subzero_conservation(Floe,Nb)
K(1) = sum(0.5*cat(1,Floe(1+Nb:end).mass).*cat(1,Floe(1+Nb:end).Ui).^2+0.5*cat(1,Floe(1+Nb:end).mass).*cat(1,Floe(1+Nb:end).Vi).^2+0.5*cat(1,Floe(1+Nb:end).inertia_moment).*cat(1,Floe(1+Nb:end).ksi_ice).^2);
T(1) = 0;
...
%              saveas(fig,['./figs/' num2str(im_num,'%03.f') '.jpg'],'jpg');
    ...
    K(i_step+1) = sum(0.5*cat(1,Floe(1+Nb:end).mass).*cat(1,Floe(1+Nb:end).Ui).^2+0.5*cat(1,Floe(1+Nb:end).mass).*cat(1,Floe(1+Nb:end).Vi).^2+0.5*cat(1,Floe(1+Nb:end).inertia_moment).*cat(1,Floe(1+Nb:end).ksi_ice).^2);
    T(i_step+1) = Time;
